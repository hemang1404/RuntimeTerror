...
try:
    ...
    class RuntimeTerrorEnv(MCPToolClient):  # type: ignore[misc]
        """Client for connecting to a RuntimeTerror server."""
    ...
    class RuntimeTerrorEnv:  # type: ignore[no-redef]
        """Minimal sync HTTP client for RuntimeTerror (no openenv-core)."""
